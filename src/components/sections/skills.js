...
const Skills = () => {
  ...
  return (
    <section id="skills">
      ...
      <StyledText ref={revealTitle}>
        <h3>
          Fabrication and Techniques Known
        </h3>
        <ul className="skills-list">
          {fabTechList && fabTechList.map((item, i) => <li key={i}>{item}</li>)}
        </ul>
        <br />
        <h3>
          Softwares Known
        ...
        <ul className="skills-list">
          {softKnownList && softKnownList.map((item, i) => <li key={i}>{item}</li>)}
        </ul>
        <br />
        <h3>
        ...
        <ul className="skills-list">
          {progLangList && progLangList.map((item, i) => <li key={i}>{item}</li>)}
        </ul>
        <br />
        <h3>
        ...
        <ul className="skills-list">
          {charTechList && charTechList.map((item, i) => <li key={i}>{item}</li>)}
        </ul>
      </StyledText>
    </section>
  );
